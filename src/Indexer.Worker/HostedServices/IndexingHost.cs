        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            foreach (var (blockchainId, blockchainConfig) in _config.Indexing.Blockchains)
            {
                ...
                var firstPassIndexingJobs = Enumerable
                    ...
                    .Select(i =>
                    {
                        var startBlock = blockchain.Protocol.StartBlockNumber + i * blockchainConfig.FirstPassIndexerLength;
                        var stopBlock = startBlock + blockchainConfig.FirstPassIndexerLength + 1;
